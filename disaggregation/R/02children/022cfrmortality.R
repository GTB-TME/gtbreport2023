...
load(here('disaggregation/R/02children/mortinput/MBB.Rdata')) #NOTE made by 0220dataprep.R
...
##  deaths by country
RESAc <- RESA[,list(deaths=mean(DeathsOnTx+DeathsOffTx+DeathsOnTxH+DeathsOffTxH)),
