...
% Outputs:
% ========
% - r: Updated model parameters that are per-capita rates
% - p: Updated model parameters that are proportions
% - prm: Updated, remaining model parameters
...
if opts.hiv || opts.provs || opts.const
    r.casefinding = 0;                                                     % The parameter 'g' in the written equations, only used for non-HIV, non-public/private countries, or for those where prior incidence was estimated to be constant
end
