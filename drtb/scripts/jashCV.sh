...
# R --slave --vanilla --args < ../R/2stanfitting.R together_LerouxIntercept_2 $SGE_TASK_ID
# R --slave --vanilla --args < ../R/2stanfitting.R separate_LerouxIntercept_2 $SGE_TASK_ID
