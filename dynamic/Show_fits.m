...
% set(ff,'Position',[680   656   463   321]);
% set(ff,'Position',[680   501   537   476]);
set(ff,'Position',[680   638   738   339]);

if ~contains(iso3,'region')
    saveas(gcf,['Eyeballing/',iso3,'_Calibrations'],'png');
else
    saveas(gcf,['Eyeballing/',iso3,'/',iso3,'_Calibrations'],'png');
end